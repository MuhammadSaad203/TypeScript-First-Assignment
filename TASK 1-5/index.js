...
// to Title Case
console.log("The person's name in Title Case would be ", personName2.replace(/\bw/g, function (c) { return c.toUpperCase(); }));
// TASK 4 : "Famous Quote"
...
var message = "In the middle of diificulty lies oppurtunity.";
